...
def parse_data(x):
    ...
    reports.append((data, time_sent, str(time_received), str(time_delay)))
    return 
...
def main():
    try:
        ...
        df = pd.DataFrame(reports, columns=["voltage_data", "sent_time", "received_time", "time_delay"])
